...
CLIENT_ID = '스포티파이 개발자 페이지 등록해둔 앱 고유 ID'
CLIENT_SECRET = '스포티파이 개발자 페이지 등록해둔 앱 시크릿'
REDIRECT_URL = '스포티파이 개발자 페이지 등록해둔 앱 리다이렉트url'
FLASK_SECRET_KEY = '세션 쿠키 위변조 방지를 하는 자물쇠 역할. 임의의 아무 값 적으면 됨'
